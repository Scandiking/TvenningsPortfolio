...
const SHOTS = [
    { file: "intent_gate.png", title: "Intent gate", caption: "Full-skjerms pause: en tidbit, en «trace the path»-gest og nedtelling før en overvåket app åpnes." },
    ...
    { file: "watched_apps.png", title: "Overvåkede apper", caption: "Sorter apper i Utility / Watched / Hidden — du velger hva som får fartsdumpen." },
    { file: "timer_adjustment.png", title: "Tidsinnstillinger", caption: "Gate-forsinkelse (8 s), øktgrense (15 min) og cooldown (30 min)." },
    { file: "tidbit_library.png", title: "Tidbit-bibliotek", caption: "Kildebelagte fakta om deceptive design — pull-to-refresh, uendelig scroll, variabel belønning." },
];
...
function PhoneShot({ file, title, caption }) {
    ...
    return (
        <figure className="flex flex-col gap-3">
            <div className="mx-auto w-full max-w-[240px] aspect-[9/20] rounded-[2rem] border-4 border-default-800 bg-content2 overflow-hidden shadow-md">
                <img
                    src={`${base}/${file}`}
                    alt={`Defang – ${title}`}
                    loading="lazy"
    ...
    return (
        <AnimatedPage className="container mx-auto px-4 py-8">
            ...
            <p className="text-default-500 max-w-3xl mb-5">
                Android-launcher som legger en bevisst pause mellom impulsen og handlingen. Ikke en blokker
                som tvinger deg til «cold turkey» — men et verktøy som bryter selve vane-loopen bak
            ...
            <AnimatedTabs variant="solid" aria-label="Defang">
                        ...
                        <CardBody className="gap-4 leading-relaxed">
                            <div>
                                ...
                                <p className="text-default-600">
                                    ...
                                    vane-loopen <span className="font-medium text-foreground">cue → rutine → belønning</span>:
                                    en varsling er signalet, appen åpner seg umiddelbart, og en algoritmestyrt feed med
                                    uendelig scroll leverer uforutsigbare belønninger som holder deg der.
                                </p>
                            </div>
                            <div>
                                <h2 className="text-xl font-semibold mb-2">Hvorfor eksisterende tiltak ikke holder</h2>
                                <p className="text-default-600">
                                    Systemtiltak — gråtone, Digital Wellbeing, minimalistiske launchere — angriper bare
                                    <span className="font-medium text-foreground"> cue-fasen</span>. De gjør ingenting når
                                    appen først er åpen. Verre: Instagrams egen tidsgrense kommer med en
                            ...
                            <div className="rounded-lg bg-content2 p-4">
                                <p className="text-sm text-default-600">
                                    ...
                                    En ren blokker fjerner bare tilgangen — symptomet. I det øyeblikket blokkeren er borte,
                                    er loopen intakt. Defang retter seg mot selve loopen: den bryter <em>cue-en</em> med en
                ...
                <Tab key="hjernen" title="Hjernen bak">
                    <div className="flex flex-col gap-4">
                        <Card>
                            ...
                            <CardBody className="leading-relaxed text-default-600">
                                <p>
                                    ...
                                    bestemt deg for noe. Defang angriper to punkter loopen faktisk lar seg røre: signalet før, og landingen etter.
                                </p>
                            </CardBody>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardBody className="leading-relaxed text-default-600">
                                <p>
                                    Et scroll gir en dopamin-topp som falmer på sekunder — akkurat kort nok til at du trenger neste.
                        ...
                        <Card>
                            ...
                            <CardBody className="leading-relaxed text-default-600">
                                <p>
                                    Systemene som jobber mot deg er ikke rettet mot kunnskapen din — de er rettet mot den delen av
                                    hjernen som handler før du tenker. Å vite at Instagram er designet for å holde deg der, har ikke
                ...
                <Tab key="virker" title="Slik virker det">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            { t: "Intent gate", d: "Når du åpner en overvåket app, dukker en full-skjerms pause opp før appen laster. Du leser en tidbit om hvordan appen manipulerer deg, og velger et forhåndsdeklarert formål — eller venter ut nedtellingen. Kan alltid avbrytes: det er en fartsdump, ikke en felle." },
                            { t: "Session timer (HUD)", d: "Inne i appen teller en liten HUD ned øktgrensen din (standard 15 min). Når den når null, skyves appen automatisk til bakgrunnen." },
                            { t: "End card med friksjon", d: "Ved øktslutt: hvor lenge du var inne, ditt eget oppgitte formål vs. tid brukt, og «Jeg trenger mer tid» — men knappen er skjult de første 30 sekundene, krever en skriftlig begrunnelse (min. 10 tegn), og gjelder bare én gang per dag på tvers av alle apper." },
                            { t: "Cooldown-lås", d: "Etter økta (eller forlengelsen) låses appen en cooldown-periode (standard 30 min). Å lukke og umiddelbart åpne igjen blokkeres. Låsen overlever omstart av telefonen." },
                            ...
                            { t: "Notification batching", d: "Varsler fra overvåkede apper holdes tilbake og leveres samlet i tidsvinduer du velger. Anrop og meldinger fra kontakter i adresseboka slipper alltid gjennom." },
                        ].map((f) => (
