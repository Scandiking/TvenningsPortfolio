...
function Projects() {
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-medium text-foreground mb-2">Prosjekter</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <motion.div
                    ...
                    className="bg-content1 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200"
                >
